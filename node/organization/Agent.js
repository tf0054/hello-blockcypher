        ...
        (0, _utils.unlockAccount)(this.props.web3.personal, this.props.lockedTime, this.props.account, this.props.password, function (result, unlockTime) {
          if (result) {
            (function () {
              ...
              var gas = instance.addOrganization.estimateGas(_this2.props.profile.name, { from: _this2.props.account });
              console.log('addOrganization {gas: %d}', gas);

              var transactionHash = instance.addOrganization(_this2.props.profile.name, { from: _this2.props.account, gas: gas });
