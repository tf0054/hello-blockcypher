...
var _Approvals = require('./Approvals2.jsx');
...
var Organization2 = function (_Organization) {
  _inherits(Organization2, _Organization);

  function Organization2() {
    _classCallCheck(this, Organization2);

    return _possibleConstructorReturn(this, (Organization2.__proto__ || Object.getPrototypeOf(Organization2)).apply(this, arguments));
  }

  _createClass(Organization2, [{
    key: 'render',
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(_Approvals2.default, { web3: this.props.web3, device: this.props.device, account: this.state.account,
                  ...
                  agent: this.state.agent, topicName: _configure.APPROVAL_TOPIC_NAME, onApproved: this.approved.bind(this),
                ...
                _react2.default.createElement(_Permissions2.default, { web3: this.props.web3, device: this.props.device, profile: this.state.profile,
                  abi: this.state.abi, topicName: _configure.PERMISSION_TOPIC_NAME })
              )
            )
          )
        )
