...
var System = function (_Component) {
  ...
  function System() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = System.__proto__ || Object.getPrototypeOf(System)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      account: '',
      password: '',
      lockedTime: 0,
  ...
  _createClass(System, [{
    ...
    value: function organizationAgentStopped(agent) {
      ...
      if (removeKey) {
        ...
        for (var _key2 in localStorage) {
          if (_key2.indexOf(_configure.ORGANIZATION_APPLICANT_PROFILE_KEY + device) == 0) {
    ...
    key: 'applicantAgentStopped',
    value: function applicantAgentStopped(agent) {
      var balance = this.props.web3.eth.getBalance(this.state.account);
      this.setState({ balance: balance });

      for (var key in localStorage) {
        if (key.indexOf(_configure.APPLICANT_AGENT_ADDRESS_KEY) == 0) {
          if (localStorage[key] == agent) {
            localStorage.removeItem(key);
          }
        }
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  ' Job applicant Agents'
                ),
                _react2.default.createElement('hr', null),
                _react2.default.createElement(_Applicants2.default, { web3: this.props.web3, account: this.state.account, password: this.state.password,
                  lockedTime: this.state.lockedTime, balance: this.state.balance, abi: this.state.abi,
                  agent: this.state.agent, onStopped: this.applicantAgentStopped.bind(this),
                  onAutoUnlocked: this.accountAutoUnlocked.bind(this) })
              )
            )
          )
