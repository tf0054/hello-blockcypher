...
var Profile2 = function (_Component) {
  _inherits(Profile2, _Component);
  ...
  function Profile2() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Profile2.__proto__ || Object.getPrototypeOf(Profile2)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      name: '',
      birthday: '',
      savedTime: null
  ...
  _createClass(Profile2, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (nextProps.profile) {
        ...
        this.setState({ name: nextProps.profile.name, birthday: nextProps.profile.birthday, savedTime: savedTime });
      }
    }
  }, {
    key: 'nameChange',
    ...
    key: 'birthdayChange',
    value: function birthdayChange(e) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_reactBootstrap.FormControl, { type: 'text', value: this.state.birthday, onChange: this.birthdayChange.bind(this) })
        ),
        _react2.default.createElement(
          _reactBootstrap.FormGroup,
          null,
          _react2.default.createElement(
            ...
            { bsStyle: 'primary', onClick: this.saveClick.bind(this),
              disabled: this.state.name.length == 0 || this.state.birthday.length == 0 },
            'Save'
          ),
          this.state.savedTime > 0 ? _react2.default.createElement(
            'span',
            null,
            '  Saved at ',
